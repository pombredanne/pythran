...
class Ancestors(ModuleAnalysis):
    ...
    Based on the tree view of the AST: each node has the Module has parent.
    The result of this anlysis is a dictionnary with nodes as key,
...
class Scope(FunctionAnalysis):
    ...
    The result is a dictionary with variable names as key and a node as value.
    '''
    ...
    def visit_FunctionDef(self, node):
        ...
        for name, udgraph in self.used_def_chain.iteritems():
            ...
            refs.extend(self.ancestors[d][-3]
